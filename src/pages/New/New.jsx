    ...
    <div className="new">
      ...
      <div className="newcontainer">
        ...
        <div className="bottom">
          <div className="left">
            <img src={file ? URL.createObjectURL(file) : "https://tse4.mm.bing.net/th?id=OIP.JttTWFVu0wYc9wlQk90xjwAAAA"} alt="profile" />
          </div>
          <div className="right">
            <form action="">
                <div className="forminput">
                    ...
                    <input type="file" id="file" onChange={e => setFile(e.target.files[0])} className="photoinput" style={{display: 'none'}} accept='.jpg, .jpeg, .png' />
                </div>
                <div className="forminput">
